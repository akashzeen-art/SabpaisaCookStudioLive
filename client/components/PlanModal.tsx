        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="block mb-4 cursor-pointer">
            <input
              ...
              value="125"
            />
            <div className="border-2 border-gray-300 rounded-xl p-4 transition-all peer-checked:border-yellow-500 peer-checked:bg-yellow-50 hover:border-yellow-400">
            ...
            <div className="border-2 border-gray-300 rounded-xl p-4 transition-all peer-checked:border-yellow-500 peer-checked:bg-yellow-50 hover:border-yellow-400">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-2xl font-bold text-yellow-600">₹199</span>
          ...
          <button
            type="submit"
            className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95"
          >
            Submit
          </button>
        </form>
