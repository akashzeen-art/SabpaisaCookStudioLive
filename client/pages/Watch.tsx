    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-white text-center">
          ...
          <button onClick={() => navigate('/')} className="px-6 py-3 bg-yellow-500 rounded-lg">
            Go to Home
          </button>
        </div>
      </div>
        ...
        <div className="w-full h-full flex items-center justify-center" ref={containerRef}>
          ...
          {!isPlaying && !isLoading && (
            <div className="absolute inset-0 flex items-center justify-center cursor-pointer" onClick={handlePlay}>
              <div className="w-20 h-20 bg-yellow-500 rounded-full flex items-center justify-center hover:bg-yellow-600 transition-colors">
